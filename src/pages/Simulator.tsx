...
const Simulator = () => {
    ...
    const calculate = () => {
        ...
        const insuranceRateAnnual = config.insurance_rate;
        const feesFixed = config.origination_fee;
        const guaranteeRatePercent = config.guarantee_rate;
        ...
        if (formData.includeInsurance) {
            monthlyInsurance = (loanAmount * (insuranceRateAnnual / 100)) / 12;
        }

        const guaranteeFee = loanAmount * (guaranteeRatePercent / 100);
        const totalFees = feesFixed + guaranteeFee;
        ...
        const taegEst = rate + (formData.includeInsurance ? insuranceRateAnnual : 0) + 0.2;
        ...
        setResult({
            ...
            insuranceRate: insuranceRateAnnual
        });
    };
